$techDir = ".\assets\tech"
$urls = @{
    "power-automate.svg" = "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/powerautomate/powerautomate-original.svg"
    "sharepoint.svg" = "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sharepoint/sharepoint-original.svg"
}
